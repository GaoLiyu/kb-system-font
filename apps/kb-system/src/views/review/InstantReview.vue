      ...
      <el-col :span="10">
        <el-card>
          ...
          <el-alert type="info" :closable="false" style="margin-top: 16px">
            ...
            <template #default> 完整审查：包含LLM语义分析，提交后台处理 </template>
          </el-alert>
        </el-card>
      </el-col>
      ...
      <el-col :span="14">
        <el-card v-if="reviewResult">
          ...
          <el-alert
            ...
            :type="
              reviewResult.risk_level === '高风险'
                ? 'error'
                : reviewResult.risk_level === '中风险'
                  ? 'warning'
                  : 'success'
            "
            :closable="false"
          ...
          <el-empty
            v-if="!reviewResult.issues?.length && !reviewResult.formula_checks?.length"
            description="未发现问题"
          />
        </el-card>
