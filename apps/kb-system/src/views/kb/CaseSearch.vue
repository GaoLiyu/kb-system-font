    ...
    <el-row :gutter="20">
          ...
          <el-form label-position="top" size="default">
            ...
            <el-form-item label="报告类型">
              <el-select
                ...
                style="width: 100%"
              >
                <el-option v-for="t in filterOptions.report_types" :key="t" :label="t" :value="t" />
              </el-select>
            </el-form-item>
            ...
            <el-form-item label="区域">
              <el-select
                ...
                style="width: 100%"
              >
                <el-option v-for="d in filterOptions.districts" :key="d" :label="d" :value="d" />
              </el-select>
            </el-form-item>

            <el-form-item label="用途">
              <el-select v-model="filters.usage" placeholder="全部" clearable style="width: 100%">
                <el-option v-for="u in filterOptions.usages" :key="u" :label="u" :value="u" />
              </el-select>
            </el-form-item>
            ...
            <el-form-item>
              ...
              <el-button style="width: 100%; margin-left: 0; margin-top: 8px" @click="handleReset">
                重置
              </el-button>
            </el-form-item>
          </el-form>
      ...
      <el-col :span="18">
        <el-card>
          ...
          <el-table v-loading="loading" :data="cases" stripe style="width: 100%">
